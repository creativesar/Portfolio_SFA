...
export default function PortfolioSection() {
    ...
    const projects = [
        ...
        {
            title: 'Tasaki',
            description: 'A premium jewelry brand known for luxurious and elegant designs. Visit for a rich catalog of products.',
            imageUrl: '/takasi.png',
            link: 'https://www.tasaki.co.uk/?_gl=1*2e2axo*_up*MQ..&gclid=CjwKCAjw-JG5BhBZEiwAt7JR68moFGL8zNL-dUJ-phKBBduwEhGrobpxVXOv8-1C__icUlSdJEHtYhoCxHwQAvD_BwE',
        },
        {
            title: 'Adresta',
            description: 'Luxury watch marketplace where buyers can discover, buy, and sell rare timepieces.',
            imageUrl: '/adresta.png',
            link: 'https://adresta.ch/en',
        },
        {
            title: 'Greenlight Consulting',
            description: 'A consultancy firm specializing in digital transformation and business growth.',
            imageUrl: '/greenlight.png',
            link: 'https://www.greenlightconsulting.com/',
        },
    ];
    ...
    return (
        <div className="min-h-[600px] bg-gray-900 text-white flex flex-col justify-center items-center py-20 px-6 sm:px-12 lg:px-24">
            <h2
                ref={portfolioRef}
